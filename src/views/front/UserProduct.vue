<template>
  <div class="d-flex justify-content-end box" style="position: fixed; right: 20px; bottom: 20px; z-index: 2;">
    ...
    <div class="row">
      <div class="col-md-3 pt-3 mb-3">
        <div class="btn-group-vertical w-100 sticky-md-top" role="group" aria-label="Basic radio toggle button group">
          <input type="radio" class="btn-check" name="btnradio" id="allCard" autocomplete="off" checked @click="setCard('', '全部')" />
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 p-3" v-for="item in filterSearch" :key="item.id">
            <div class="card h-100 animated" >
              ...
              <div class="card-body">
                <div class="cardTitle py-2 h4 text-center">{{ item.title }}</div>
                <div
