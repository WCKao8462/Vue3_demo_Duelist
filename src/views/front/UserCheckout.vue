<template>
  ...
  <div class="container my-5">
    ...
    <div class="text-center" v-if="order.is_paid">
      <img src="../../assets/img/orderSuccess.jpg" class="p-3 mb-3" alt="購物成功" />
      <div id="firstAnchor" class="display-5 text-center text-warning">謝謝惠顧!!</div>
      <p class="text-white text-center py-3">我們會盡快將你的牌組寄送，讓你早日成為決鬥王~</p>
      <div class="text-center mb-4">
      <button type="button" class="btn btn-outline-light btn-lg fs-4 border-5 fw-bolder" @click="toProducts">繼續看牌 <i class="bi bi-basket2-fill"></i></button>
    </div>
    </div>
...
@import "@/assets/scss/viewScss/_userCheckout";
</style>
